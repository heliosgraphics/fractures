...
export const type: Array<FractureRuleType> = [
	...
	},
	{
		...
		description: "Heading 1 font and line.",
	},
	{
		selector: "h2",
		declarations: {
		...
		description: "Heading 2 font and line.",
	},
	{
		selector: "h3",
		declarations: {
		...
		description: "Heading 3 font and line.",
	},
	{
		selector: "h4",
		declarations: {
		...
		description: "Heading 4 font and line.",
	},
	{
		selector: "h5",
		declarations: {
		...
		description: "Heading 5 font and line.",
	},
	{
		selector: "h6",
		declarations: {
		...
		description: "Heading 6 font and line.",
	},
	{
		selector: "p",
		declarations: {
		...
		description: "Paragraph font and line.",
	},
	{
		selector: "small",
		declarations: {
		...
		description: "Small font and line.",
	},
	{
		selector: "tiny",
		declarations: {
		...
		description: "Tiny font and line.",
	},

	{
		selector: "sans",
		declarations: { fontFamily: "var(--font-family-sans)" },
		description: "Sans font-family.",
	},
	{
		selector: "serif",
...

	{
		...
		description: "Pre white-space.",
	},
	{
		selector: "pre-line",
		declarations: { whiteSpace: "pre-line" },
		description: "Pre-line white-space",
	},
	{
		selector: "pre-wrap",
		declarations: { whiteSpace: "pre-wrap" },
		description: "Pre-wrap white-space",
	},
	{
		selector: "nowrap",
		declarations: { whiteSpace: "nowrap" },
		description: "Nowrap white-space",
	},
