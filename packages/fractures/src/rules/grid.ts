...
export const grid: Array<FractureRuleType> = [
	...
	{ selector: "grid-gap-x-9", declarations: { gridRowGap: "var(--box-9)" } },
	{
		...
		declarations: { gridRowGap: "var(--box-10)" },
	},
	{
		selector: "grid-gap-x-11",
		declarations: { gridRowGap: "var(--box-11)" },
	},
	{
		selector: "grid-gap-x-12",
		declarations: { gridRowGap: "var(--box-12)" },
	},
	{
		selector: "grid-gap-x-13",
		declarations: { gridRowGap: "var(--box-13)" },
	},
	{
		selector: "grid-gap-x-14",
		declarations: { gridRowGap: "var(--box-14)" },
	},
	{
		selector: "grid-gap-x-15",
		declarations: { gridRowGap: "var(--box-15)" },
	},
	{
		selector: "grid-gap-x-16",
		declarations: { gridRowGap: "var(--box-16)" },
	},
	{
		selector: "grid-gap-x-24",
		declarations: { gridRowGap: "var(--box-24)" },
	},
	{
		selector: "grid-gap-x-32",
		declarations: { gridRowGap: "var(--box-32)" },
	},
	{
		selector: "grid-gap-x-40",
		declarations: { gridRowGap: "var(--box-40)" },
	},
	{
		selector: "grid-gap-x-48",
		declarations: { gridRowGap: "var(--box-48)" },
	},

	{
		selector: "grid-gap-y-1",
		declarations: { gridColumnGap: "var(--box-1)" },
	},
	{
		selector: "grid-gap-y-2",
		declarations: { gridColumnGap: "var(--box-2)" },
	},
	{
		selector: "grid-gap-y-3",
		declarations: { gridColumnGap: "var(--box-3)" },
	},
	{
		selector: "grid-gap-y-4",
		declarations: { gridColumnGap: "var(--box-4)" },
	},
	{
		selector: "grid-gap-y-5",
		declarations: { gridColumnGap: "var(--box-5)" },
	},
	{
		selector: "grid-gap-y-6",
		declarations: { gridColumnGap: "var(--box-6)" },
	},
	{
		selector: "grid-gap-y-7",
		declarations: { gridColumnGap: "var(--box-7)" },
	},
	{
		selector: "grid-gap-y-8",
		declarations: { gridColumnGap: "var(--box-8)" },
	},
	{
		selector: "grid-gap-y-9",
		declarations: { gridColumnGap: "var(--box-9)" },
	},
	{
		selector: "grid-gap-y-10",
		declarations: { gridColumnGap: "var(--box-10)" },
	},
	{
		selector: "grid-gap-y-11",
		declarations: { gridColumnGap: "var(--box-11)" },
	},
	{
		selector: "grid-gap-y-12",
		declarations: { gridColumnGap: "var(--box-12)" },
	},
	{
		selector: "grid-gap-y-13",
		declarations: { gridColumnGap: "var(--box-13)" },
	},
	{
		selector: "grid-gap-y-14",
		declarations: { gridColumnGap: "var(--box-14)" },
	},
	{
		selector: "grid-gap-y-15",
		declarations: { gridColumnGap: "var(--box-15)" },
	},
	{
		selector: "grid-gap-y-16",
		declarations: { gridColumnGap: "var(--box-16)" },
	},
	{
		selector: "grid-gap-y-24",
		declarations: { gridColumnGap: "var(--box-24)" },
	},
	{
		selector: "grid-gap-y-32",
		declarations: { gridColumnGap: "var(--box-32)" },
	},
	{
		selector: "grid-gap-y-40",
		declarations: { gridColumnGap: "var(--box-40)" },
	},
	{
		selector: "grid-gap-y-48",
		declarations: { gridColumnGap: "var(--box-48)" },
	},
