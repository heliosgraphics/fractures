...
export const flex: Array<FractureRuleType> = [
  ...
  { selector: 'flex-gap-px', declarations: { gap: 'var(--box-px)' }, hasBreakpoints: true },
  { selector: 'flex-gap-1', declarations: { gap: 'var(--box-1)' }, hasBreakpoints: true },
  { selector: 'flex-gap-2', declarations: { gap: 'var(--box-2)' }, hasBreakpoints: true },
  { selector: 'flex-gap-3', declarations: { gap: 'var(--box-3)' }, hasBreakpoints: true },
  { selector: 'flex-gap-4', declarations: { gap: 'var(--box-4)' }, hasBreakpoints: true },
  { selector: 'flex-gap-5', declarations: { gap: 'var(--box-5)' }, hasBreakpoints: true },
  { selector: 'flex-gap-6', declarations: { gap: 'var(--box-6)' }, hasBreakpoints: true },
  { selector: 'flex-gap-7', declarations: { gap: 'var(--box-7)' }, hasBreakpoints: true },
  { selector: 'flex-gap-8', declarations: { gap: 'var(--box-8)' }, hasBreakpoints: true },
  { selector: 'flex-gap-9', declarations: { gap: 'var(--box-9)' }, hasBreakpoints: true },
  { selector: 'flex-gap-10', declarations: { gap: 'var(--box-10)' }, hasBreakpoints: true },
  { selector: 'flex-gap-11', declarations: { gap: 'var(--box-11)' }, hasBreakpoints: true },
  { selector: 'flex-gap-12', declarations: { gap: 'var(--box-12)' }, hasBreakpoints: true },
  { selector: 'flex-gap-13', declarations: { gap: 'var(--box-13)' }, hasBreakpoints: true },
  { selector: 'flex-gap-14', declarations: { gap: 'var(--box-14)' }, hasBreakpoints: true },
  { selector: 'flex-gap-15', declarations: { gap: 'var(--box-15)' }, hasBreakpoints: true },
  { selector: 'flex-gap-16', declarations: { gap: 'var(--box-16)' }, hasBreakpoints: true },
  { selector: 'flex-gap-24', declarations: { gap: 'var(--box-24)' }, hasBreakpoints: true },
  { selector: 'flex-gap-32', declarations: { gap: 'var(--box-32)' }, hasBreakpoints: true },
  { selector: 'flex-gap-40', declarations: { gap: 'var(--box-40)' }, hasBreakpoints: true },
  { selector: 'flex-gap-48', declarations: { gap: 'var(--box-48)' }, hasBreakpoints: true },
