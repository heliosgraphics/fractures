...
export const type: Array<FractureRuleType> = [
  ...
  { selector: 'lighter', declarations: { fontWeight: 'var(--font-weight-lighter)' }, description: 'Lighter font-weight.' },
  { selector: 'light', declarations: { fontWeight: 'var(--font-weight-light)' }, description: 'Light font-weight.' },
  { selector: 'normal', declarations: { fontWeight: 'var(--font-weight-normal)' }, description: 'Normal font-weight.' },
  { selector: 'bold', declarations: { fontWeight: 'var(--font-weight-bold)' }, description: 'Bold font-weight.' },
  { selector: 'bolder', declarations: { fontWeight: 'var(--font-weight-bolder)' }, description: 'Bolder font-weight.' },
