...
import { getFlexUtility } from "@fractures/library/utils/flex";
...
describe('getFlexUtility', () => {
  ...
  it.skip('Generates without duplicated classes', () => expect(getFlexUtility(MOCK_FLEX_DUPLICATE, 'flex')).toEqual(MOCK_FLEX_DUPLICATE_CLASSES));
