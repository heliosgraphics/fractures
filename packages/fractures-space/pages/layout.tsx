...
const LayoutPage: React.FC<{}> = () => (
	<Layout title="Layout">
		...
		<PageContainer>
			<P>
					Responsive selectors are marked with a purple dot and can be used with any of these prefixes:<br/><br/>
					<code><b>sm</b>:<em>selector</em></code><br/>
					<code><b>md</b>:<em>selector</em></code><br/>
					<code><b>lg</b>:<em>selector</em></code><br/>
					<code><b>xl</b>:<em>selector</em></code><br/>
					<code><b>xxl</b>:<em>selector</em></code>
				</P>
