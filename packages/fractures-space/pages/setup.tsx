			...
			<SectionBlock title="Variables">
				...
				<SectionCode
					...
					code={[
						...
						`&nbsp;`,
						`--rgb-blue-100: <mark>232,231,253</mark>;`,
						`--rgb-blue-200: <mark>185,184,249</mark>;`,
						`--rgb-blue-300: <mark>139,137,245</mark>;`,
						`--rgb-blue-400: <mark>93,90,241</mark>;`,
						`--rgb-blue-500: <mark>46,43,238</mark>;`,
						`--rgb-blue-600: <mark>21,17,212</mark>;`,
						`--rgb-blue-700: <mark>16,14,165</mark>;`,
						`--rgb-blue-800: <mark>11,10,118</mark>;`,
